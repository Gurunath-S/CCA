                      ...
                      <CardContent className="p-6 flex flex-col justify-between h-full">
                        <Box>
                          <Box className="flex justify-between items-start mb-3">
                            ...
                            {c.submissionCount > 0 && (
                              <Chip
                                label={`${c.submissionCount} ${c.submissionCount === 1 ? 'submission' : 'submissions'}`}
                                size="small"
                                className="rounded-full text-xs font-semibold bg-teal-50 dark:bg-teal-950/30 text-teal-600 dark:text-teal-400"
                              />
                            )}
                          </Box>
